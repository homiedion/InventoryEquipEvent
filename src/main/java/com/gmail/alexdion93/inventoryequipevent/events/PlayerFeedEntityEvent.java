...
public class PlayerFeedEntityEvent extends Event implements Cancellable {
   ...
   * @param entity The entity being fed.
   * @param item The new item.
   * @param hand The hand slot being interacted with
   */
  public PlayerFeedEntityEvent(Player player, Entity entity, ItemStack item, EquipmentSlot hand) {
    this.player = player;
    this.item = item;
    this.entity = entity;
    this.hand = hand;
